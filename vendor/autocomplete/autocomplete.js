$(function(){
  var nomes = [
    ...
    {value: 'Feminismo', data:'feminismo'},
    {value: 'Feminismo interseccional', data: 'feminismointerseccional'},
    {value: 'Feminismo negro', data: 'feminismonegro'},
    {value: 'Gaslighting', data:'gaslighting'},
    {value: 'Homeapropriando', data: 'homeapropriando'},
    {value: 'Homexplicando', data:'homexplicando'},
    {value: 'Hominterrompendo', data:'hominterrompendo'},
    {value: 'Machismo', data:'machismo'},
    {value:'Patriarcado', data:'patriarcado'},
    {value:'Slutshaming', data:'slutshaming'},
    {value:'Transfeminismo', data: 'transfeminismo'}
  ];
